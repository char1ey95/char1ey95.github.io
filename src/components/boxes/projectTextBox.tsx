    ...
    return (
        <div className="flex flex-col p-2 sm:px-4">
            ...
            <div className="flex justify-end mb-2">
                <span className="py-1 px-3 bg-gradient-to-r from-[#f0dfdf] to-[#DDEFBB] hover:from-[#FFFFFF] hover:to-[#e6f9c2] dark:from-[#3fa49d] dark:to-[#3f4954] dark:hover:from-[#55e0d7] dark:hover:to-[#687788] rounded font-semibold cursor-pointer hover:animate-pulse">
                    자세히 보기
                </span>
            </div>
